...
const prompt = ai.definePrompt({
  ...
  Parse durations like "1.5h" as 90 minutes and "3-4 hours" as 180 minutes. The final bedtime task should have a duration of 0.
