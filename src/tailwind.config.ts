...
export default {
  ...
  safelist: [
    ...
    'hover:bg-rose-800', 'hover:border-rose-500/80', 'hover:text-rose-100', 'text-rose-400',
    'hover:bg-orange-800', 'hover:border-orange-500/80', 'hover:text-orange-100', 'text-orange-400',
    'hover:bg-purple-800', 'hover:border-purple-500/80', 'hover:text-purple-100', 'text-purple-400',
    'hover:bg-blue-800', 'hover:border-blue-500/80', 'hover:text-blue-100', 'text-blue-400',
    'hover:bg-cyan-800', 'hover:border-cyan-500/80', 'hover:text-cyan-100', 'text-cyan-400',
    'hover:bg-amber-800', 'hover:border-amber-500/80', 'hover:text-amber-100', 'text-amber-400',
    'hover:bg-lime-800', 'hover:border-lime-500/80', 'hover:text-lime-100', 'text-lime-400',
    'hover:bg-red-800', 'hover:border-red-500/80', 'hover:text-red-100', 'text-red-400',
    'hover:bg-green-800', 'hover:border-green-500/80', 'hover:text-green-100', 'text-green-400',
    'hover:bg-stone-800', 'hover:border-stone-500/80', 'hover:text-stone-100', 'text-stone-400',
    'hover:bg-teal-800', 'hover:border-teal-500/80', 'hover:text-teal-100', 'text-teal-400',
    'hover:bg-indigo-800', 'hover:border-indigo-500/80', 'hover:text-indigo-100', 'text-indigo-400',
    'hover:bg-fuchsia-800', 'hover:border-fuchsia-500/80', 'hover:text-fuchsia-100', 'text-fuchsia-400',
    'hover:bg-sky-800', 'hover:border-sky-500/80', 'hover:text-sky-100', 'text-sky-400',
