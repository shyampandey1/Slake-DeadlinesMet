...
const defaultRoutines: { [key in ProfileType]: Omit<UserPresetTask, "id" | "order">[] } = {
    ...
    "Entrepreneur": [
        ...
        { name: "Working Lunch", duration: 30, icon: "Utensils", category: "Breaks & Meals" },
    ...
    "Healthcare Professional": [
        ...
        { name: "Recovery Meal & Connect with Family", duration: 60, icon: "Utensils", category: "Evening Wind-down" },
    ...
    "Sales": [
        ...
        { name: "Lunch & Decompress", duration: 45, icon: "Utensils", category: "Breaks & Meals" },
    ...
    "Student": [
        ...
        { name: "Quick Breakfast", duration: 15, icon: "Utensils", category: "Morning Routine" },
        ...
        { name: "Lunch with friends", duration: 60, icon: "Utensils", category: "Breaks & Meals" },
