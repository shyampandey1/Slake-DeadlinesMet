...
const creativeProfessionalRoutine: Omit<UserPresetTask, "id" | "order" | "profession">[] = [
    ...
    { name: "Inspiration & Research Block", duration: 60, icon: "Lightbulb", category: "Work & Focus" },
    ...
    { name: "Short Walk", duration: 15, icon: "Footprints", category: "Breaks & Meals" },
    { name: "Drink a glass of water", duration: 1, icon: "Droplets", category: "Work & Focus" },
    { name: "Skill Practice / Tutorial", duration: 45, icon: "Wrench", category: "Work & Focus" },
    { name: "Admin & Client Communication", duration: 60, icon: "Mail", category: "Work & Focus" },
    ...
    { name: "Social Time with Family/Friends", duration: 60, icon: "Users", category: "Evening Wind-down" },
