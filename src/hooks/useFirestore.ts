...
const defaultRoutines: { [key in ProfileType]: Omit<UserPresetTask, "id" | "order">[] } = {
    ...
    "Technical": [
        { name: "Drink a glass of water", duration: 1, icon: "Droplets", category: "Morning Routine" },
        { name: "Light Exercise & Mobility", duration: 15, icon: "StretchHorizontal", category: "Morning Routine" },
        { name: "Review System Alerts & Plan Day", duration: 20, icon: "ListChecks", category: "Morning Routine" },
