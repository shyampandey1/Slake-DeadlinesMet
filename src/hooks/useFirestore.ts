...
const defaultRoutines: { [key in ProfileType]: Omit<UserPresetTask, "id" | "order">[] } = {
    ...
    "Technical": [
        { name: "Drink a glass of water", duration: 1, icon: "Droplets", category: "Morning Routine" },
        { name: "Review System Alerts & Logs", duration: 20, icon: "Mail", category: "Morning Routine" },
        { name: "Daily Stand-up Meeting", duration: 15, icon: "Users", category: "Morning Routine" },
        { name: "Drink a glass of water", duration: 1, icon: "Droplets", category: "Work & Focus" },
        { name: "Deep Work on Infrastructure", duration: 120, icon: "BrainCircuit", category: "Work & Focus" },
        ...
        { name: "Support Tickets & User Issues", duration: 60, icon: "Wrench", category: "Work & Focus" },
        { name: "Drink a glass of water", duration: 1, icon: "Droplets", category: "Health & Wellness" },
    ...
    "Healthcare Professional": [
        ...
        { name: "Drink a glass of water", duration: 1, icon: "Droplets", category: "Afternoon Routine" },
        { name: "During-Shift Micro-Reset (Deep breaths)", duration: 1, icon: "Wind", category: "Afternoon Routine" },
        { name: "Charting & Patient Notes", duration: 60, icon: "PenTool", category: "Afternoon Routine" },
        { name: "Eat small, healthy snacks for energy", duration: 10, icon: "Apple", category: "Afternoon Routine" },
        { name: "Drink a glass of water", duration: 1, icon: "Droplets", category: "Evening Wind-down" },
        { name: "Mindful Commute (calm music)", duration: 20, icon: "Car", category: "Evening Wind-down" },
        { name: "Recovery Meal & Connect with Family/Partner", duration: 60, icon: "Utensils", category: "Evening Wind-down" },
