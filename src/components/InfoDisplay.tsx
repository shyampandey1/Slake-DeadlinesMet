...
export default function InfoDisplay() {
  ...
  return (
    <div className={cn(
        "relative text-xs rounded-lg bg-card/50 backdrop-blur-sm border border-border",
        "before:absolute before:inset-y-0 before:left-0 before:w-8 before:bg-gradient-to-r before:from-[var(--timer-background-color)] before:to-transparent before:pointer-events-none before:z-10",
